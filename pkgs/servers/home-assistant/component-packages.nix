...

{
  ...
  components = {
    ...
    "bmw_connected_drive" = ps: with ps; [
      bimmer-connected
    ]; # missing inputs: bimmer-connected.optional-dependencies.china
    "bond" = ps: with ps; [
      bond-async
    ];
    ...
    "ring" = ps: with ps; [
      ha-ffmpeg
      ring-doorbell
    ]; # missing inputs: ring-doorbell.optional-dependencies.listen
    "ripple" = ps: with ps; [
